...
function Home (){
    return (
     ...
     <div className="zin">
        ...
        <svg width={500} height={500} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="study">
            ...
            <g id="desk">
              <rect id="Rectangle 973" x={4} y={31} width={56} height={5} fill="#DEDCDB" stroke="#453F3C" strokeWidth={2} />
              <rect id="Rectangle 987" x={10} y={36} width={30} height={6} fill="#DEDCDB" stroke="#453F3C" strokeWidth={2} />
              <rect id="Rectangle 975" x={6} y={36} width={4} height={24} fill="#DEDCDB" stroke="#453F3C" strokeWidth={2} />
              <rect id="Rectangle 974" x={40} y={36} width={18} height={24} fill="#DEDCDB" stroke="#453F3C" strokeWidth={2} />
